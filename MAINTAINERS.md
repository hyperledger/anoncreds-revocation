...
| ---------- | ------------------------ | ----------- | ----------------------- |
| Admin      | The GitHub Maintain role | Admin       | `Anoncreds-admins`      |
| Maintainer | The GitHub Maintain role | Maintain    | `Anoncreds-maintainers`, `Anoncreds-spec-editors` |
...
| ----------------- | --------------- | ---------- | ---- | ---------- | ------------------------ | ------------------- |
| Andrew Whitehead  | andrewwhitehead | Admin      |      |            | cywolf@gmail.com         | BC Gov              |
| Artur Philipp     | ArPhil          | Maintainer |      |            | a.philipp@tu-berlin.de   | IDunion             |
| Berend Sliedrecht | blu3beri        | Maintainer |      |            | berend@animo.id          | Animo Solutions     |
| Darko Kulic       | dkulic          | Maintainer |      |            | darko.kulic@evernym.com  | SICPA               |
| Sam Curran        | TelegramSam     | Maintainer |      |            | sam@indicio.tech         | Indico PBC          |
| Stephen Curran    | swcurran        | Admin      |      |            | swcurran@cloudcompass.ca | BC Gov              |
| Timo Glastra      | TimoGlastra     | Admin      |      |            | timo@animo.id            | Animo Solutions     |
| Wade Barnes       | WadeBarnes      | Admin      |      |            | wade@neoterictech.ca     | BC Gov              |
